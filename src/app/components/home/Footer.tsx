...
import logo from "../../assests/Group 361.svg";
  ...
  return (
    <footer className="[box-shadow:0px_-1px_8px_0px_#00000033]">
      ...
      <div className="max-w-[1440px] mx-auto px-4 pt-9 ">
          ...
          <div className="flex flex-col lg:flex-row lg:text-left text-center items-center gap-4 justify-between">
            <div className="lg:w-[70%] w-full ">
              <h2 className="font-semibold lg:text-4xl text-2xl mb-4">
                Tell your family and friends about biz_name
              </h2>
              <p className="text-sm lg:text-2xl">
                Let others know about this amazing platform! Easily share the
                page with your friends and network through your favorite social
                media channels.
              </p>
            </div>
        ...
        <p className="text-center lg:text-2xl text-sm max-w-[597px] mx-auto ">
          If you notice any issues, inappropriate content, or violations of our
          guidelines, please report them to us.{" "}
        </p>
        <p className="text-center pt-3 pb-10">
          <a href="" className="px-3 py-2 rounded-lg border border-[#C11012] text-[#C11012] text-base font-medium" target="_blank">
...
<div className="grid grid-cols-1 place-items-center md:grid-cols-4 gap-8">
      ...
      <div className="  bg-black py-3 px-3 mx-auto  md:text-center  lg:text-left">
        <div className="max-w-[1440px] w-full mx-auto grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
          <div className="cell medium-6 flex items-center">
            <div className="copyright w-full">
              <p className="font-light md:text-xs text-[6px]  md:text-left text-white">
                {" "}
          ...
          <div className="cell medium-6 p-4 lg:p-0">
            <div className="cta flex  justify-end    text-right">
              {/* <a href="">
...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2690_68" result="shape"/>
              ...
              <p className="text-white md:text-xs text-[6px] mr-2">
                <span className="mr-2">Powered by</span>{" "}
                <a target="_blank" href="https://www.hellopintude.com/">
                  {" "}
                  <img className="inline md:w-auto w-10" src={logo.src} />
                </a>
              </p>
            </div>
          </div>
