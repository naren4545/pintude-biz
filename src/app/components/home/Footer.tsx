...
<div className='flex flex-col lg:flex-row items-center'>
    ...
    <div className='lg:w-[30%] w-full'>
      <div className='lg:mt-0 mt-5'>  <Button href="/" className=""><svg className='inline mr-2' width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
