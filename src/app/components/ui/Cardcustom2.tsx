    ...
    <>
      ...
      >
        ...
        <div className="">
          ...
          <div className="p-4 absolute top-[33px] left-[11]">
            <h2 className="text-3xl font-bold text-white">{brodcast.heading}</h2>
            <div className="flex items-center mt-2 text-sm text-white">
              ...
              <p className="text-xl font-medium text-white">{brodcast.time}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {isOpen && (
        <Modal isOpen={isOpen}>
          ...
          <div
        className="max-w-[90vw]  relative bg=[] mx-auto bg-white rounded-lg overflow-hidden cursor-pointer"
...
<div
        ...
        <Image alt="dot" src={dot} className="absolute overflow-hidden right-[18px] top-[18px]" />
        <div className="">
          <div className="text-center">
