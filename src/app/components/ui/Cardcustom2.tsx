...
const CardCustom2 = () => {
  return (
    <div className="max-w-[986px] relative bg=[] mx-auto bg-white shadow-lg rounded-lg overflow-hidden "  
    >
